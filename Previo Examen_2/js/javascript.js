function init() {
    ...
    myDiagram.linkTemplate =
      $(go.Link,
        { toShortLength: 8, relinkableFrom: true, relinkableTo: true },  // allow the user to relink existing links
        $(go.Shape,
          { strokeWidth: 3 },
          new go.Binding("stroke", "color")),
        $(go.Shape,
          { toArrow: "Chevron", stroke: null },
          new go.Binding("fill", "color")),
        { // this tooltip Adornment is shared by all links
          toolTip:
            $("ToolTip",
              $(go.TextBlock, { margin: 10 },  // the tooltip shows the result of calling linkInfo(data)
      ...
      $(go.Group, "Vertical",
        ...
        $(go.Panel, "Auto",
          ...
          $(go.Shape, "Ellipse",  // the rectangular shape around the members
            {
              fill: "rgba(255, 81, 81, 0.8)", stroke: "rgba(22, 30, 84, 0.8)", strokeWidth: 10,
              portId: "", cursor: "star",  // the Shape is the port, not the whole Node
              // allow all kinds of links from and to this port
              fromLinkable: true, fromLinkableSelfNode: true, fromLinkableDuplicates: true,
              toLinkable: true, toLinkableSelfNode: true, toLinkableDuplicates: true
            }),
    ...
    var nodeDataArray = [
      { key: 1, text: "Debian", color: "crimson" },
      { key: 2, text: "Ubuntu", color: "orange", group: 6 },
      { key: 3, text: "Xubunut", color: "#20B2AA", group: 6},
      { key: 4, text: "Kubuntu", color: "Steelblue", group: 6 },
      { key: 5, text: "Lubuntu", color: "lightblue",  group: 6},
      { key: 6, text: "Entornos de escritorio", color: "Black", isGroup: true }
    ];
    var linkDataArray = [
      { from: 1, to: 2, color: "black" },
      { from: 2, to: 3, color: "rgba(255, 165, 0, 1)"}, /*Narnaj Neon*/
      { from: 2, to: 4, color: "rgba(255, 165, 0, 1)"}, /*Narnaj Neon*/
      { from: 2, to: 5, color: "rgba(255, 165, 0, 1)"}, /*Narnaj Neon*/
    ];
