function init() {
    ...
    myDiagram.linkTemplate =
      $(go.Link,
        ...
        { // this tooltip Adornment is shared by all links
          toolTip:
            $("ToolTip",
              $(go.TextBlock, { margin: 3 },  // the tooltip shows the result of calling linkInfo(data)
                new go.Binding("text", "text", linkInfo))
            ),
      ...
      $(go.Group, "Vertical",
        ...
        $(go.Panel, "Auto",
          ...
          $(go.Shape, "Rectangle",  // the rectangular shape around the members
            {
              fill: "DarkSlateGray", stroke: "Black", strokeWidth: 10,
    ...
    var nodeDataArray = [
      ...
      { key: 4, text: "Estados de un proceso", color: "Black", isGroup: true }
    ];
    var linkDataArray = [
      { from: 3, to: 2, text: "4", color: "white"},
      { from: 1, to: 2, text: "2", color: "white"}, 
      { from: 2, to: 1, text: "3", color: "white"}, 
      { from: 1, to: 3, text: "1", color: "white"}, 
    ];
